...
func (m *OAuthAccessToken) MarshalTo(data []byte) (int, error) {
	...
	data[i] = 0x52
	i++
	i = encodeVarintGenerated(data, i, uint64(len(m.IdentityName)))
	i += copy(data[i:], m.IdentityName)
	if len(m.IdentityProviderGroups) > 0 {
		for _, s := range m.IdentityProviderGroups {
			data[i] = 0x5a
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (this *OAuthAccessToken) String() string {
	...
	s := strings.Join([]string{`&OAuthAccessToken{`,
		...
		`IdentityName:` + fmt.Sprintf("%v", this.IdentityName) + `,`,
		`IdentityProviderGroups:` + fmt.Sprintf("%v", this.IdentityProviderGroups) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *OAuthAccessToken) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IdentityProviderGroups", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IdentityProviderGroups = append(m.IdentityProviderGroups, string(data[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipGenerated(data[iNdEx:])
...
var fileDescriptorGenerated = []byte{
	...
	,
}
